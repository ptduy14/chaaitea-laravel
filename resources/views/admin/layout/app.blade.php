...
>
  <head>
    ...
    <title>Dashboard ChaaiTea</title>
  ...
  <body>
    ...
    <!-- Vendors JS -->
    <script src="/admins/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="/admins/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="/admins/assets/js/dashboards-analytics.js"></script>
