...
@else
    <div class="empty-cart">
        ...
        <h3>Oops, giỏ hàng của bạn đang rỗng</h3>
        <p>Có vẻ như bạn chưa thêm sản phẩm nào vào giỏ hàng. Không sao, hãy tiếp tục và khám phá thêm các sản phẩm khác của chúng tôi</p>
    </div>
@endif
</div>
